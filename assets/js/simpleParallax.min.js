...
!function(t, e) {
    ...
    s.m = i = [function(t, e, i) {
        ...
        var s = new (function() {
          ...
          , r = function() {
            for (var t, e = "transform webkitTransform mozTransform oTransform msTransform".split(" "), i = 0; void 0 === t; )
        ...
        var h = function() {
            ...
            return function(t, e, i) {
                ...
                value: function() {
                    ...
                    this.animate(),
                    0 < this.settings.delay && setTimeout(function() {
                        t.setTransitionCSS()
                    }, 10),
                    this.isInit = !0)
                }
        ...
        var f, m, p, d = !0, g = !1, v = [], y = function() {
            function i(t, e) {
                !function(t, e) {
                    if (!(t instanceof e))
                        throw new TypeError("Cannot call a class as a function")
            ...
            return function(t, e, i) {
                ...
                value: function() {
                    clearTimeout(p),
                    p = setTimeout(this.handleResize, 500)
                }
            }, {
                key: "handleResize",
                value: function() {
                ...
                value: function() {
                    ...
                    v = v.filter(function(t) {
                        return e.elements.includes(t.element) ? (i.push(t),
                        !1) : t
                    });
                    for (var t = i.length - 1; 0 <= t; t--)
                        i[t].unSetStyle(),
                        !1 === this.settings.overflow && i[t].unWrapElement();
                    (f = v.length) || (window.cancelAnimationFrame(m),
